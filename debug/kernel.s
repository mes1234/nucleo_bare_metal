...
.L33:
	...
	ldr	r3, .L34
	ldr	r3, [r3]
	.loc 2 80 33 discriminator 3
	ldr	r2, .L34+4
	lsls	r3, r3, #4
	add	r3, r3, r2
	ldr	r2, [r7]
	str	r2, [r3]
	.loc 2 81 48 discriminator 3
	ldr	r3, .L34
	ldr	r3, [r3]
	ldr	r2, .L34+4
	lsls	r3, r3, #4
	add	r3, r3, r2
	ldr	r2, [r3]
	.loc 2 81 19 discriminator 3
	ldr	r3, .L34
	ldr	r3, [r3]
	.loc 2 81 48 discriminator 3
	mov	r1, r2
	.loc 2 81 36 discriminator 3
	ldr	r2, .L34+4
	lsls	r3, r3, #4
	add	r3, r3, r2
	adds	r3, r3, #4
	...
	str	r3, [r2]
.L32:
	.loc 2 77 19 discriminator 1
	ldr	r3, .L34
	ldr	r3, [r3]
	.loc 2 77 5 discriminator 1
	cmp	r3, #4
	bls	.L33
	.loc 2 84 1
	nop
