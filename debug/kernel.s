...
.LFB33:
	...
	b	.L28
.L29:
	.loc 2 56 41 discriminator 3
	ldr	r3, .L30
	ldr	r3, [r3]
	adds	r3, r3, #1
	lsls	r3, r3, #12
	.loc 2 56 17 discriminator 3
	ldr	r2, [r7, #4]
	subs	r3, r2, r3
	str	r3, [r7]
	.loc 2 57 19 discriminator 3
	ldr	r3, .L30
	ldr	r3, [r3]
	.loc 2 57 33 discriminator 3
	ldr	r2, .L30+4
	lsls	r3, r3, #4
	add	r3, r3, r2
	ldr	r2, [r7]
	str	r2, [r3]
	.loc 2 58 49 discriminator 3
	ldr	r3, .L30
	ldr	r3, [r3]
	ldr	r2, .L30+4
	lsls	r3, r3, #4
	add	r3, r3, r2
	ldr	r2, [r3]
	.loc 2 58 19 discriminator 3
	ldr	r3, .L30
	ldr	r3, [r3]
	.loc 2 58 49 discriminator 3
	mov	r1, r2
	.loc 2 58 37 discriminator 3
	ldr	r2, .L30+4
	lsls	r3, r3, #4
	add	r3, r3, r2
	adds	r3, r3, #4
	...
	str	r3, [r2]
.L28:
	.loc 2 54 19 discriminator 1
	ldr	r3, .L30
	ldr	r3, [r3]
	.loc 2 54 5 discriminator 1
	cmp	r3, #1
	bls	.L29
	.loc 2 61 1
	nop
