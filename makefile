build: src/main.c startup/startup.s startup/stm32.ld clean
	@echo
	@echo "Build production image"
	arm-none-eabi-gcc -c -mcpu=cortex-m3 -mthumb -o obj/main.o src/main.c
	arm-none-eabi-as -c -mcpu=cortex-m3 -mthumb -o obj/startup.o startup/startup.s
	arm-none-eabi-ld -Tstartup/stm32.ld -o main.elf obj/startup.o obj/main.o
